  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Local PDF uses Webassembly to edit your PDFs inside your Browser. Your files won't leave your System, they will not be sent to another server Currently, we support merging PDFs, optimizing PDFs and extracting Infromation like Images from PDF FilesMerge multiple PDFs into one. Get rid of redundant page resources like embedded fonts and images
        ...
        />
        <meta property="og:description" content="Local PDF uses Webassembly to edit your PDFs inside your Browser. Your files won't leave your System, they will not be sent to another server Currently, we support merging PDFs, optimizing PDFs and extracting Infromation like Images from PDF FilesMerge multiple PDFs into one" />
